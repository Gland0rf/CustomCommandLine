...
def on_submit(event=None):
    ...
    commands = ["encrypt", "cd", "ls", "exit", "cls", "clear", "mkdir", "createdir", "mkfile", "createfile", "rem", "remove", "read", "readfile", "edit", "editfile", "nano", "vol", "volume", "alias", "pwd", "mv", "move"]
    ...
    elif result[0] == "cd" or result[0] in aliases["cd"]:
        if len(result) < 2:
